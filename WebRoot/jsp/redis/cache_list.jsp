...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  $(function(){ 
  	//设置leftbar
		$("#redisCache li").eq(1).addClass("on");
		$("#redisCache li").eq(1).children("a").addClass("sselect");
  });
  <%--
  ...
  <body style="overflow: scroll">
	...
	<form action="" method="post" id="totalForm" >
		    <div class="right_cont">
		          <ul class="breadcrumb">
		          	<li>当前位置：<span style="color:red;font-size: 18px; font-weight: bold;">Redis缓存店铺信息列表--【${ fn:length(shopList) }条】</span></li>
		          </ul>
